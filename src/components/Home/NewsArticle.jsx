...
function NewsArticle() {
    ...
    return (
        <div className='bg-[#111111] pt-[60px] pb-[60px]'>
            <div className='container'>
                ...
                <div className='grid grid-cols-2 gap-x-[30px]'>
                    {
                        data.map((el, i) => <Link to="/" key={i}><div className='py-[72px] px-[60px] bg-[#212121] rounded-[15px]'>
                            <h3 className='text-white mb-[12px] font-bold leading-[38px] text-[30px]'>{el.title}</h3>
