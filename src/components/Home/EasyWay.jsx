...
function EasyWay() {
    return (
        <div className='py-[120px] bg-[#111111]'>
            <div className='container'>
                <div className='flex items-center gap-x-[130px]'>
                    ...
                    <div className='w-[50%]'>
                        ...
                        <h2 className='text-[48px] leading-[1.2] font-bold text-white tracking-[-0.6px]'>Easy ways to use AI tools, and tools to build AI.</h2>
